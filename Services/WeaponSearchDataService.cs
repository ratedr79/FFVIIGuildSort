...
namespace FFVIIEverCrisisAnalyzer.Services
{
    public sealed class WeaponSearchDataService
    {
        ...
        private static readonly Dictionary<int, string> StatusEffectTypes = new()
        {
            ...
            { 31, "Single-Tgt. Fire Dmg. Rcvd. Up" },
            { 32, "All-Tgt. Fire Dmg. Rcvd. Up" },
            { 33, "Single-Tgt. Ice Dmg. Rcvd. Up" },
            { 34, "All-Tgt. Ice Dmg. Rcvd. Up" },
            { 35, "Single-Tgt. Lightning Dmg. Rcvd. Up" },
            { 36, "All-Tgt. Lightning Dmg. Rcvd. Up" },
            { 37, "Single-Tgt. Earth Dmg. Rcvd. Up" },
            { 38, "All-Tgt. Earth Dmg. Rcvd. Up" },
            { 39, "Single-Tgt. Water Dmg. Rcvd. Up" },
            { 40, "All-Tgt. Water Dmg. Rcvd. Up" },
            { 41, "Single-Tgt. Wind Dmg. Rcvd. Up" },
            { 42, "All-Tgt. Wind Dmg. Rcvd. Up" },
            { 43, "Torpor" }
        };
